#!/usr/bin/env python3
"""
MySQL Database Import Script for WOS XML Parser Output

This script imports CSV files generated by the WOS XML Parser into a MySQL database.
...
Examples:
  ...
  %(prog)s --drop-existing  # WARNING: Deletes existing database
    ...
    print("="*60)
    print("WOS XML Parser - MySQL Import Tool")
    print("="*60)
